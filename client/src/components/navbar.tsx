      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 sm:h-24">
          ...
          <Link href="/" className="flex items-center space-x-3 flex-shrink-0">
            <img src={logoPath} alt="Carivoo Logo" className="h-16 sm:h-20 w-auto bg-gradient-to-r from-black to-gray-400 rounded-lg p-2" style={{ filter: 'grayscale(100%) brightness(1.8) contrast(1.5)' }} />
          </Link>
