    ...
    return (
      <div className="min-h-screen relative overflow-x-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-20 left-0 w-32 h-32 opacity-5">
            <div className="text-9xl">🌴</div>
          </div>
          <div className="absolute top-1/2 right-0 w-24 h-24 opacity-5">
            <div className="text-7xl">🌴</div>
          </div>
          <div className="absolute bottom-32 left-1/3 w-28 h-28 opacity-5">
